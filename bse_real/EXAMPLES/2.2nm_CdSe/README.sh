...
# calculations for CdSe require ~60 electrons
...
# NOTE: if you want to exactly match the reference output, a
# pre-made output.dat file has been included in the reference_output
# directory. Link this file into ./bse to check your run!
# 2) Link the bse_real.x executable
# ln -s PATH_TO_EXEC/bse_real.x .

# and then run the code with the command
# srun -n 1 ./bse_real.x | tee -a run.dat
...
# srun -n 16 -c 128 --cpu-bind=cores ./bse_real.x
# or
# mpirun -n 16 -c 128 --cpu-bind=cores ./bse_real.x
