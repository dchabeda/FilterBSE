...
#include "lapack.h"
    ...
    #define FORTRAN_STRLEN_DECL {, size_t jobu_len, size_t jobvt_len}
    #define FORTRAN_STRLEN_PASS , strlen(&jobu), strlen(&jobvt)
#else
    #define FORTRAN_STRLEN_DECL
    #define FORTRAN_STRLEN_PASS
#endif
...
//Hmat.c
zomplex dotp(zomplex *psi, double *phi,long m,long ngrid,double dv);
