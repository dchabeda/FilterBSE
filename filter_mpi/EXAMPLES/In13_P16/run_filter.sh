...
pseudoDir="${executableBaseDir}/pots/pots_III_V/"
...
# Neighbor lists
cp $hFilterDir/*eighbor* $sFilterDir/
...
cd $sFilterDir
let "n_cpus = 2 * $OMP_NUM_THREADS"
srun -n 1 -c $n_cpus --cpu_bind=cores ./Filter.x 2> error.dat > run.dat
